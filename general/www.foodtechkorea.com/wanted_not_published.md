...
NeoVim에서 harpoon 패키지, 그리고 터미널에서 tmux를 사용했습니다.
이로써 파일 간 전환, 코드 줄 간 이동 시간을 단축키 하나로 해결하여 이동 시간을 0.5초 미만으로, 84퍼센트 이상 축소했습니다.
덕분에 저는 집중력이 흐트러지지 않고 오늘도 즐겁게 코딩을 했습니다.
